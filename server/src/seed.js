...
var require_library = __commonJS((exports, module) => {
  var __dirname =
      "/Users/nodirbekrajaboff/Desktop/projects/kasaba/apps/server/src/generated/prisma/runtime",
    __filename =
      "/Users/nodirbekrajaboff/Desktop/projects/kasaba/apps/server/src/generated/prisma/runtime/library.js";
  ...
  var k = (e, r, t) => (
    ...
    _o(
      r || !e || !e.__esModule
        ? Vt(t, "default", { value: e, enumerable: true })
        : t,
      e
    )
  );
  ...
  var us = ne((Lg, ls) => {
    ...
    ls.exports = {
      supportsColor: qc,
      stdout: hi(yi(true, as.isatty(1))),
      stderr: hi(yi(true, as.isatty(2))),
    };
  });
  var ds = ne((Fg, ps) => {
    var jc = us(),
...
`
  ...
  globalThis.DEBUG_COLORS ??= oi.DEBUG_COLORS
    ? oi.DEBUG_COLORS === "true"
    : true;
  var Yr = {
    enable(e) {
...
`);
  ...
  function pe(e) {
    return Object.assign(e, {
      ...
      and: (r) => q(e, r),
      or: (r) => Hu(e, r),
      select: (r) => (r === undefined ? Jo(e) : Jo(r, e)),
    });
  }
  function Ju(e) {
    return pe({
    ...
    return pe({
      [Oe]: () => ({
        match: (r) => {
          ...
          return (
            zr(e, Ge).forEach((i) => n(i, undefined)),
  ...
  function Jo(...e) {
    let r = typeof e[0] == "string" ? e[0] : undefined,
      t = e.length === 2 ? e[1] : typeof e[0] == "string" ? undefined : e[0];
    return pe({
      [Oe]: () => ({
        match: (n) => {
          let i = { [r ?? Wt]: n };
  ...
  var pi = class e {
    ...
    when(r, t) {
      ...
      return new e(
        this.input,
        n ? { matched: true, value: t(this.input, this.input) } : ci
      );
    }
    otherwise(r) {
...
Env vars from ${Y(l)} overwrite the ones from ${Y(a)}
  ...
  m.hyperbolicCosine = m.cosh = function () {
    ...
    (t = s.precision),
      ...
      (o = Pr(s, 1, o.times(r), new s(1), true));
    ...
    if (
      ...
      do
        if (
          ...
          +J(l.d).slice(i + 1, i + 15) + 1 == 100000000000000 &&
            (l = y(l, p + 1, 0));
          break;
        }
      while (at(l.d, (i += 10), d));
  ...
  m.precision = m.sd = function (e) {
    var r,
      t = this;
    if (e !== undefined && e !== !!e && e !== 1 && e !== 0) throw Error(He + e);
    return (
  ...
  m.toDecimalPlaces = m.toDP = function (e, r) {
    ...
    return (
      ...
      e === undefined
        ? t
        : (ie(e, 0, Ke),
          r === undefined ? (r = n.rounding) : ie(r, 0, 8),
          y(t, e + t.e + 1, r))
    );
  };
  m.toExponential = function (e, r) {
    ...
    return (
      e === undefined
        ? (t = xe(n, true))
        : (ie(e, 0, Ke),
          r === undefined ? (r = i.rounding) : ie(r, 0, 8),
          (n = y(new i(n), e + 1, r)),
          (t = xe(n, true, e + 1))),
  ...
  m.toFixed = function (e, r) {
    ...
    return (
      e === undefined
        ? (t = xe(i))
        : (ie(e, 0, Ke),
          r === undefined ? (r = o.rounding) : ie(r, 0, 8),
          (n = y(new o(i), e + i.e + 1, r)),
          (t = xe(n, false, e + n.e + 1))),
  ...
  m.toNearest = function (e, r) {
    ...
    if (((t = new n(t)), e == null)) {
      ...
      if (
        ((e = new n(e)), r === undefined ? (r = n.rounding) : ie(r, 0, 8), !t.d)
      )
        return e.s ? t : e;
        ...
        : ((w = false),
          ...
          i.d &&
            ...
            at(i.d, n, o) &&
              ...
              +J(i.d).slice(n + 1, n + 15) + 1 == 100000000000000 &&
                (i = y(i, n + 1, 0)))),
          (i.s = s),
          (w = true),
          (l.rounding = o),
  ...
  m.toSignificantDigits = m.toSD = function (e, r) {
    ...
    return (
      e === undefined
        ...
        : (ie(e, 1, Ke), r === undefined ? (r = n.rounding) : ie(r, 0, 8)),
      y(new n(t), e, r)
    );
  };
  m.toString = function () {
  ...
  function Ws(e, r, t, n) {
    ...
    for (w = false; ; ) {
      if (
        (t % 2 && ((o = o.times(r)), $s(o.d, s) && (i = true)),
        (t = X(t / 2)),
        t === 0)
      ) {
  ...
  function Gi(e, r, t, n) {
    ...
    if (
      (h
        ? (ie(t, 1, Ke), n === undefined ? (n = f.rounding) : ie(n, 0, 8))
  ...
  function ed(e) {
    var r,
      ...
      a = [];
    if (
      (e === undefined ? (e = this.precision) : ie(e, 1, Ke),
      (n = Math.ceil(e / b)),
      this.crypto)
    )
        ...
        for (let s in r)
          if (r.hasOwnProperty(s)) {
            ...
            l === "Object" && !i[o(a)]
              ...
              : l === "Array" && !i[o(a)] && ((i[o(a)] = true), e(a, t, s, i));
          }
      },
    },
    plugins: {},
        ...
        for (let P = 0; P < S.length; ++P) {
          ...
          for (let V = n, te = i; V < r.length; te += r[V].length, ++V) {
            ...
            if (
              ...
              u != 1 && v.matchGrammar(e, r, t, V, te, true, g),
              o)
            )
              break;
          }
...
`);
  ...
  function wa(e) {
    ...
    if (e === undefined) return new Q("undefined");
    ...
    getAllQueryCallbacks(r, t) {
      return this.queryCallbacksCache.getOrCreate(`${r}:${t}`, () => {
        ...
        return !o || !(o[r] || o.$allModels || o[t] || o.$allOperations)
          ? n
          : (o[r] !== undefined &&
              (o[r][t] !== undefined && i.push(o[r][t]),
              o[r].$allOperations !== undefined && i.push(o[r].$allOperations)),
            r !== "$none" &&
              o.$allModels !== undefined &&
              (o.$allModels[t] !== undefined && i.push(o.$allModels[t]),
              o.$allModels.$allOperations !== undefined &&
                i.push(o.$allModels.$allOperations)),
            o[t] !== undefined && i.push(o[t]),
  ...
  var zi = class e {
    ...
    nestSelection(r) {
      let t = this.findField(r),
        n = t?.kind === "object" ? t.type : undefined;
      return new e({
        ...this.params,
        modelName: n,
  ...
  function he(e, r) {
    let t = um(r),
      ...
      i = new Proxy(e, {
        ...
        set(o, s, a) {
          return t.get(s)?.getPropertyDescriptor?.(s)?.writable === false
            ? false
...
`);
  ...
  function qr(e = {}) {
    ...
    return Object.entries(r).reduce(
      (n, [i, o]) => (
        ja[i] !== undefined ? (n.select[i] = { select: o }) : (n[i] = o), n
      ),
      { select: {} }
    );
  }
  ...
  function qm(e) {
    ...
    return ar({
      ...
      getPropertyValue(i) {
        let o = Ha(i);
        if (e._runtimeDataModel.models[o] !== undefined) return ao(e, o);
        if (e._runtimeDataModel.models[i] !== undefined) return ao(e, i);
      },
      ...
      : jn({
          ...
          visitor: (a, l, u) => {
            ...
            return za({
              ...
              modelName: c,
              select: u.select,
              omit: u.select ? undefined : { ...o?.[c], ...u.omit },
              extensions: n,
            });
          },
        });
...
`;
  ...
  var po = class {
    ...
    registerNewError(r) {
      let t = 0;
      for (; this.registeredErrors[t] !== undefined; ) t++;
  ...
  var Ct = class extends $ {
    ...
    logs;
    constructor(r, t) {
      super("Engine not started: healthcheck timeout", C(r, true)),
        (this.logs = t);
    }
  };
...
${r}`,
  ...
  async function mf(e, r) {
    ...
    if (e.includes("accelerate") && n !== "0.0.0" && n !== "in-memory")
      return n;
    let [i, o] = n?.split("-") ?? [];
    if (o === undefined && df.test(i)) return i;
  ...
  var qt = class {
    ...
    async requestBatch(
      ...
      let o = n?.kind === "itx" ? n.options : undefined,
        s = Mr(r, n);
      return (
    ...
    async withRetry(r) {
      for (let t = 0; ; t++) {
        ...
        try {
          ...
          this.logEmitter.emit("warn", {
            message: `Attempt ${t + 1}/${Ol} failed for ${r.actionGerund}: ${
              i.message ?? "(unknown)"
            }`,
            timestamp: new Date(),
            target: "",
  ...
  var Gr = class {
    ...
    constructor(r, t) {
      (this.libraryLoader = t ?? Ll),
        r.engineWasm !== undefined && (this.libraryLoader = t ?? Fl),
        (this.config = r),
...
`);
  ...
  var Co =
    ...
    (t) => {
      ...
      if (Fn(t))
        (n = t.sql),
          (i = { values: Qr(t.values), __prismaRawParameters__: true });
      ...
      (this.logEmitter = t),
        ...
        (this.dataloader = new zn({
          ...
          singleLoader: async (n) => {
            let i =
                n.transaction?.kind === "itx" ? ru(n.transaction) : undefined,
      ...
      if (e) {
        ...
        for (let [t, n] of Object.entries(e)) {
          ...
          if (typeof n != "object" || Array.isArray(n))
            throw new O(`Invalid value ${JSON.stringify(
              e
        ...
        try {
          ...
          if (
            ...
            (this._engineConfig = {
              ...
              transactionOptions: {
                maxWait: l.transactionOptions?.maxWait ?? 2000,
                timeout: l.transactionOptions?.timeout ?? 5000,
...
var require_prisma = __commonJS((exports) => {
  var __dirname =
    "/Users/nodirbekrajaboff/Desktop/projects/kasaba/apps/server/src/generated/prisma";
  ...
  var config = {
    generator: {
      ...
      previewFeatures: [],
      sourceFilePath:
        "/Users/nodirbekrajaboff/Desktop/projects/kasaba/apps/server/prisma/schema.prisma",
      isCustomOutput: true,
    },
    relativeEnvPaths: {
      rootEnvPath: null,
...
`,
    inlineSchemaHash:
      "e02a78c37f2fd8fdbfaa9c5e61f99034ec6042ec81cd20d7f871db991d9acfe4",
    copyEngine: true,
  };
  var fs = __require("fs");
  ...
  path.join(
    process.cwd(),
    "src/generated/prisma/libquery_engine-linux-musl.so.node"
  );
  ...
  path.join(
    process.cwd(),
    "src/generated/prisma/libquery_engine-linux-arm64-openssl-1.1.x.so.node"
  );
  path.join(__dirname, "libquery_engine-linux-arm64-openssl-3.0.x.so.node");
  path.join(
    process.cwd(),
    "src/generated/prisma/libquery_engine-linux-arm64-openssl-3.0.x.so.node"
  );
...
function hashPassword(password, salt) {
  return new Promise((resolve, reject) => {
    crypto2.scrypt(password.normalize(), salt, 64, (error, hash) => {
...
var createSuperAdmin = async () => {
  const salt = generateSalt();
  const hashedPassword = await hashPassword(superAdminData.password, salt);
  ...
  for (let i = 0; i < placesData.length; i++)
    await prisma.place.upsert({
      ...
      create: {
        ...
        title: placesData[i].title,
        languageCode: placesData[i].languageCode,
      },
      update: {
        name: placesData[i].name,
        title: placesData[i].title,
...
(async () => {
  try {
    await Promise.all([createSuperAdmin(), createPlaces()]);
    console.log("CREATED");
  } catch (error) {
